...
@Component({
  selector: 'app-cust-ven-view',
  templateUrl: './cust-ven-view.component.html',
  styleUrls: ['./cust-ven-view.component.scss']
})

export class CustVenViewComponent implements OnInit {

  public gridData: any = [];

  public add_route_link = "/estimate-item/CustVenAddEdit"
  ...
  constructor(private router: Router, private service: CustVenService, private CommonService: CommonService) { }

  ngOnInit(): void {
    this.fetchCustVenData();
  }
  ...
  fetchCustVenData() {
    ...
    this.service.fetchCustVenData().subscribe(
      data => {
  ...
  onEdit(data: any) {
    this.router.navigateByUrl('/estimate-item/CustVenAddEdit/' + data.OPTM_CV_CODE);
  }
  ...
  delete_row() {
    ...
    this.service.deleteCustVenData(this.GetItemData).subscribe(
      data => {
