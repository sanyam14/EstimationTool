...
@Component({
  selector: 'app-overhead-view',
  templateUrl: './overhead-view.component.html',
  styleUrls: ['./overhead-view.component.scss']
})

export class OverheadViewComponent implements OnInit {

  public gridData: any = [];

  public add_route_link = "/estimate-item/OverHeadAddEdit"
  ...
  constructor(private router: Router, private service: OverHeadService, private CommonService: CommonService) { }

  ngOnInit(): void {
    this.fetchOverHeadData();
  }
  ...
  fetchOverHeadData() {
    ...
    this.service.fetchoverHeadData().subscribe(
      data => {
  ...
  onEdit(data: any) {
    this.router.navigateByUrl('/estimate-item/OverHeadAddEdit/' + data.OPTM_OVERHEADGRPCODE);
  }
  ...
  onDeleteClick(data: any) {
    ...
    this.rowId = data.OPTM_OVERHEADGRPCODE;
  }
  ...
  delete_row() {
    ...
    this.GetItemData.push({
      ...
      OPTM_OVERHEADGRPCODE: this.rowId,
      GUID: sessionStorage.getItem("GUID"),
      UsernameForLic: sessionStorage.getItem("loggedInUser")
    });
    this.service.deleteOverHeadData(this.GetItemData).subscribe(
      data => {
