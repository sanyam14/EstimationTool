...
export class DepartViewComponent implements OnInit {
  ...
  public add_route_link = "/estimate-item/DepartAddEdit"
  ...
  constructor(private router: Router, private service: DepartmentService, private CommonService: CommonService) { }
  ...
  fetchDeptData() {
    ...
    this.service.fetchDepartData().subscribe(
      data => {
  ...
  onEdit(data: any) {
    this.router.navigateByUrl('/estimate-item/DepartAddEdit/' + data.OPTM_DEPTCODE);
  }
  ...
  delete_row() {
    ...
    this.GetItemData.push({
      ...
      OPTM_DEPTCODE: this.rowId,
      GUID: sessionStorage.getItem("GUID"),
      UsernameForLic: sessionStorage.getItem("loggedInUser")
    });
    this.service.deleteDepartData(this.GetItemData).subscribe(
      data => {
