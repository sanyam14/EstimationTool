...
export class CategoryviewComponent implements OnInit {
  ...
  public add_route_link = "/estimate-item/CategoryAddEdit"
  ...
  constructor(private router: Router, private service: CatalogueService, private CommonService: CommonService) { }
  ...
  fetchCatalogueData() {
    ...
    this.service.fetchCatalogueData().subscribe(
      data => {
  ...
  onEdit(data: any) {
    this.router.navigateByUrl('estimate-item/CategoryAddEdit/' + data.OPTM_SEQ_ID);
  }
  ...
  delete_row() {
    ...
    this.service.deleteCatalogueData(this.GetItemData).subscribe(
      data => {
