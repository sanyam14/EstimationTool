...
@Component({
  selector: 'app-assembly-relation-view',
  templateUrl: './assembly-relation-view.component.html',
  styleUrls: ['./assembly-relation-view.component.scss']
})
export class AssemblyRelationViewComponent implements OnInit {

  public gridData: any = [];

  public add_route_link = "/estimate-item/AssemblyRelAddEdit"
  ...
  constructor(private router: Router, private service: AssembelyrelService, private CommonService: CommonService) { }

  ngOnInit(): void {
   
      
    
    this.fetchAssemblyRelData();
  }
  ...
  fetchAssemblyRelData() {
    CommonData.made_changes = true;

    this.service.fetchAssembelyRelData().subscribe(
      data => {
  ...
  onEdit(data: any) {
    this.router.navigateByUrl('estimate-item/AssemblyRelEdit/' + data.OPTM_SEQ_ID);
  }
  ...
  onDeleteClick(data: any) {
    ...
    this.rowId = data.OPTM_SEQ_ID;
  }

  // function for getting tree view 

  onTreeViewClick(data: any) {
    this.GetItemData = []
    this.GetItemData.push({
      CompanyDBId: sessionStorage.getItem("selectedComp"),
      OPTM_PARENT_ASSB: data.OPTM_PARENT_ASSB,
      GUID: sessionStorage.getItem("GUID"),
      UsernameForLic: sessionStorage.getItem("loggedInUser")
    });

    this.service.treeViewAssemblyData(this.GetItemData).subscribe(
      data => {
  ...
  delete_row() {
    ...
    this.GetItemData.push({
      CompanyDBId: sessionStorage.getItem("selectedComp"),
      OPTM_SEQ_ID: this.rowId,
      GUID: sessionStorage.getItem("GUID"),
      UsernameForLic: sessionStorage.getItem("loggedInUser")
    });
    this.service.deleteAssemblyData(this.GetItemData).subscribe(
      data => {
