...
export class DashboardComponent implements OnInit {
  ...
  public estimateWorking_route_link: any = "/estimate-item/EstimateWorkingAddEdit";
  public estimationCost_rout_Link : any = "/estimate-item/EstimationCostAddEdit";
  public estimateWorking_rout_Link : any = "/estimate-item/AssemblyRelationView";
  public departView_view_rout_Link : any = "/estimate-item/DepartView";
  public estimation_list_rout_Link : any = "/estimate-item/EstimateWorkingView";

  public treeNodes: any[] = [ 
    {
      categoryName: "Labor Task",
      subCategories: [
        { subCategoryName: "Task1"},
        { subCategoryName: "Task2" },
        { subCategoryName: "Task3" },
      ],
    },
    {
      categoryName: "Shipping Task",
      subCategories: [
        { subCategoryName: "Task1" },
        { subCategoryName: "Task2" },
        { subCategoryName: "Task3" },
  ...
  check_component_exist(unique_key, level) {
    ...
    if (unique_key != "" && unique_key != null && unique_key != undefined) {
      data = this.data.filter(function (obj) {
